...
module.exports = function (env, argv) {
  return {
    ...
    entry: {
      ...
      buttonsScript: path.resolve(__dirname, 'src/pages/Content/buttonsScript.tsx'),
      dialogScript: path.resolve(__dirname, 'src/pages/Content/dialogScript.tsx'),
      ...
      snackbarScript: path.resolve(__dirname, 'src/pages/Content/snackbarScript.tsx'),
    },
